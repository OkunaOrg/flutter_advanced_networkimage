...
void myPaintImage({
  ...
  if (centerSlice != null) {
    ...
    outputSize = Size(outputSize.width - sliceBorder.dx, outputSize.height - sliceBorder.dy);
    inputSize = Size(inputSize.width - sliceBorder.dx, inputSize.height - sliceBorder.dy);
  }
  ...
  if (centerSlice != null && sliceBorder != null) {
    outputSize = Size(outputSize.width + sliceBorder.dx, outputSize.height + sliceBorder.dy);
    destinationSize = Size(destinationSize.width + sliceBorder.dx, destinationSize.height + sliceBorder.dy);
